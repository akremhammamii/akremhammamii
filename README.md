...
# 👋 Hi, I'm Akrem Hammami  
### 💼 QA Engineer | 🧪 Test Automation | 🤖 AI-Driven Testing | 🛠️ DevOps Practices  
...
- 🤖 Learning & exploring **AI for Testing**  
- 💬 Ask me about: `Selenium`, `Cucumber`, `Java`, `Postman`, `SQL`, `CI/CD`, `Jenkins`, `Docker`  
- ⚡ Fun fact: *Automation is good, but AI will change everything*  
...
![Mantis](https://img.shields.io/badge/MantisBT-215732?style=for-the-badge)
![TestQuality](https://img.shields.io/badge/TestQuality-2B7CFF?style=for-the-badge)
...
## 🐍 Snake Animation (Followers & Activity)
...
## 🚀 Highlight Projects
➡️ **POM Selenium Framework**  
➡️ **Cucumber BDD Framework**  
➡️ **API Testing Collections (Postman)**  
➡️ **CI/CD Pipeline with Jenkins + Docker**
